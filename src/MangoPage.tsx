    ...
    <div className="mango-page">
      ...
      <div className="paragraph1">
        ...
        <p>
          ...
          through the fruiting season on the farm premises. And finally do 'pick and drop' of weeds with a mini 
      ...
      <div className="foiler-section">
        <div className="foiler-text">
          <p>
            At the beginning of flowering during late January, we spray neem-oil for fungus protection and 
            ...
            Algol village. Neem-oil is usually available at Sangham Co-operative Oil Mill run by local women 
            in Algol village under the guidance of DDS, Pastapur, Zaheerabad. Hotter day and cooler night is 
            ideal condition for the flowers to proceed to fruiting stage comfortably. Our region in Telangana 
            (closer to Bidar) is specifically known for this combination of the day-night climate conditions.
          </p>
        </div>
      ...
      <div className="paragraph3">
        <p>
          Once the fruiting is set and fruits have come to a reasonable size around March end, we apply 
      ...
      <div className="paragraph4">
        <p>
          Our fruits are usually matured to pluck around May end, little later than rest of the places in 
          Telangana. We do harvesting gradually concentrating on only big and matured fruits during first 
          ...
          Finally we cloth dry it and package in crates with rice hay to be sent to air tight room.
        </p>
      </div>
      ...
      <div className="harvesting">
        ...
        <p>
          It is kept in air tight room for two days to trigger the ripening process. After this it is kept 
          in open space to continue to ripen but at a slower pace. It will take around ten days for it to 
          fully ripen. Finally we package 90% ripened fruit and send it to our customers. During this entire 
          time of post-harvesting we need to keep track of damaged fruits and dispose off them carefully. 
          We dig a rectangular hole and bury them 1 feet deep with 5 inches of soil on top. Usually there 
          will be a wastage of around 20% depending on many factors like rain during harvesting, presence 
          of dry twigs and rotten fruits on the farm etc.
        </p>
      </div>
